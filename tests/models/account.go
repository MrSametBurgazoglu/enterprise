...
var databaseAccountListOperationHook = func(ctx context.Context, operationInfo *client.OperationInfo, model *AccountList, operationFunc func() error) error {
	return operationFunc()
}

func SetDatabaseAccountOperationHook(f func(ctx context.Context, operationInfo *client.OperationInfo, model *Account, operationFunc func() error) error) {
...
func (t *Account) SetIDField() {
	if _, exist := t.changedFields[AccountTableIDField]; !exist {
		t.changedFields[AccountTableIDField] = t.id
		t.changedFieldsList = append(t.changedFieldsList, AccountTableIDField)
	}

}
func (t *Account) SetNameField() {
	if _, exist := t.changedFields[AccountTableNameField]; !exist {
		t.changedFields[AccountTableNameField] = t.name
		t.changedFieldsList = append(t.changedFieldsList, AccountTableNameField)
	}
...
func (t *Account) SetDenemeIDField() {
	if _, exist := t.changedFields[AccountTableDenemeIDField]; !exist {
		t.changedFields[AccountTableDenemeIDField] = t.denemeid
		t.changedFieldsList = append(t.changedFieldsList, AccountTableDenemeIDField)
	}
...
func (t *Account) Refresh() error {
	return databaseAccountOperationHook(
		...
		t,
		func() error {
			return t.client.Refresh(t.ctx, t, &t.result, AccountTableIDField, t.id)
		},
	)
}
...
func (t *Account) Update() error {
	return databaseAccountOperationHook(
		...
		t,
		func() error {
			return t.client.Update(t.ctx, AccountTableName, t.changedFields, t.changedFieldsList, AccountTableIDField, t.id)
		},
	)
}
...
func (t *Account) Delete() error {
	return databaseAccountOperationHook(
		...
		t,
		func() error {
			return t.client.Delete(t.ctx, AccountTableName, AccountTableIDField, t.id)
		},
	)
}
...
func (t *AccountList) Update(list ...*Account) error {
	return databaseAccountListOperationHook(
		...
		func() error {
			...
			return t.client.BulkUpdate(t.ctx, AccountTableName, list[0].changedFields, list[0].changedFieldsList, AccountTableIDField, valueList)
		},
	)
}
...
func (t *AccountResult) SelectID() {
	v := &client.SelectedField{Name: AccountTableIDField, Value: &t.id}
	t.selectedFields = append(t.selectedFields, v)
}

func (t *AccountResult) SelectName() {
	v := &client.SelectedField{Name: AccountTableNameField, Value: &t.name}
	t.selectedFields = append(t.selectedFields, v)
}

func (t *AccountResult) SelectSurname() {
	v := &client.SelectedField{Name: AccountTableSurnameField, Value: &t.surname}
	t.selectedFields = append(t.selectedFields, v)
}
