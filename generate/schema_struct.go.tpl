...
var database{{.TableName}}OperationHook = func(ctx context.Context, operationInfo *client.OperationInfo, model *{{.TableName}}, operationFunc func() error) error {
    return operationFunc()
}

var database{{.TableName}}ListOperationHook = func(ctx context.Context, operationInfo *client.OperationInfo, model *{{.TableName}}List, operationFunc func() error) error {
    return operationFunc()
}

func SetDatabase{{.TableName}}OperationHook(f func(ctx context.Context, operationInfo *client.OperationInfo, model *{{.TableName}}, operationFunc func() error) error){
    database{{.TableName}}OperationHook = f
}

func SetDatabase{{.TableName}}ListOperationHook(f func(ctx context.Context, operationInfo *client.OperationInfo, model *{{.TableName}}List, operationFunc func() error) error){
...
{{range .Fields}}
{{- if eq .IsNillable false -}}
func (t *{{$.TableName}}) Get{{.GetName}}Nillable() *{{.GetBaseType}}{
...
func (t *{{$.TableName}}) {{.GetName}}IN(v ...{{.GetBaseType}}) bool{ {{if .IsNillable}}
    ...
    return slices.Contains(v, {{if .IsNillable}}*t.{{.GetNameLower}}{{else}}t.{{.GetNameLower}}{{end}})
}
{{end}}{{end}}
...
func (t *{{$.TableName}}) GetChangedFields() map[string]any{
...
func (t *{{.TableName}}) Refresh() error{
    return database{{.TableName}}OperationHook(
        ...
        t,
        func() error {
            return t.client.Refresh(t.ctx, t, &t.result, {{.TableName}}Table{{.IDField}}Field, t.{{.IDFieldLower}})
        },
    )
}
...
func (t *{{.TableName}}) Update() error{
    return database{{.TableName}}OperationHook(
        ...
        t,
        func() error {
            return t.client.Update(t.ctx, {{.TableName}}TableName, t.changedFields, t.changedFieldsList, {{.TableName}}Table{{.IDField}}Field, t.{{.IDFieldLower}})
        },
    )
}
...
func (t *{{.TableName}}) Delete() error{
    return database{{.TableName}}OperationHook(
        ...
        t,
        func() error {
            return t.client.Delete(t.ctx, {{.TableName}}TableName, {{.TableName}}Table{{.IDField}}Field, t.{{.IDFieldLower}})
        },
    )
}
...
func (t *{{.TableName}}List) Update(list ...*{{.TableName}}) error{
    return database{{.TableName}}ListOperationHook(
        ...
        func() error {
            ...
            return t.client.BulkUpdate(t.ctx, {{.TableName}}TableName, list[0].changedFields, list[0].changedFieldsList, {{.TableName}}Table{{.IDField}}Field, valueList)
        },
    )
}
